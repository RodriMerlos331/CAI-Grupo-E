...
namespace Grupo_E.Almacenes
{
    public enum EstadoEncomiendaEnum
    {
        ...
        //EnCDDestino, //Despachas en CD , esperando retiro o distribución UM, no sería necesario este estado 7
        PendienteRetiroCD, //8
        PendienteEntregaDomicilio, //legó al CD y está esperando que el fletero la pase a buscar 9
        PendienteEntregaAgencia, //10
        ...
        EnTransitoUMDestino, //Fletero pasó por el CD Destino y está yendo a entregar encomiendas pendiente entrega domicilio/agencia //11
